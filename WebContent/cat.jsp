	...
	<div class="container">
		<div class="dog_food_area">
			<div class="area_first">
				<ul>
					<li><a href="shop.html">商城首页 <span>&gt</span></a></li>
			...
			<div class="area_second">
				<ul>
					<li class="clearfix"><span class="dt">分类:</span>
						<div class="dd clearfix">
							<a>国产狗粮</a> <a>进口狗粮</a> <a>泰迪贵宾专用粮</a> <a>处方粮</a>
						</div></li>
					<li class="clearfix"><span class="dt">价格:</span>
						<div class="dd clearfix">
							<a class="cur">全部</a> <a>￥0-50</a> <a>￥51-100</a> <a>￥101—200</a>
							<a>￥201-500</a> <a>￥501-1000</a> <a>￥1000以上</a>
						</div></li>
				</ul>
			</div>
			<div class="list_mt">
				<div class="sort">
					...
					<div class="dd">
						<a>默认</a> <a>价格</a> <a>销量</a> <a>好评数</a> <a>上架时间</a>
					</div>
				</div>
			</div>
		</div>
				...
				<li>
					<div class="in">
						<div class="pic" style="height: 200px; width: 200px;">
							<a> <img src="img/shop/food1.jpg" />
							</a>
						</div>
						<div class="name">
							<a>汉优新品低敏盐去泪痕专用成犬粮500g</a>
						</div>
						<div class="num clearfix">
							<span class="f1 price"> <em>￥78.00</em> <del>￥79.00</del>
							</span> <span class="fr count">已售6</span>
						</div>
					</div>
				</li>
				<li>
