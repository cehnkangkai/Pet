...
<meta charset="utf-8">
<title>无标题文档</title>
<link rel="stylesheet" href="css/publish-pet-claim.css">
...
<script type="text/javascript">
	...
	function checkForm() {
		...
		if (petSort=="" || petBreed=="" || petLink == "" || petTitle == "" || petSex == "") {
			return false;
...
<body>
	...
	<div class="header">
		<ul>
			...
			<li class="active"><a href="publish-pet-claim.jsp">发布认领</a></li>
		</ul>
	</div>
	<!--当前位置-->
	...
	<form action="${pageContext.request.contextPath }/rypet_savePet.action"
		...
		<div class="collected">
			<div class="collected-left">
				...
				<div class="collected-con">
					<p class="ff">
						<span>体型：</span> <input type="text" name="petBody"
							placeholder="肥胖">
					</p>
					<p class="ff">
					...
					<p class="ff">
						<span>毛发：</span> <input type="text" name="petHair"
							placeholder="例如：白色">
					</p>
					<p class="ff">
						<span>发现地址：</span> <select name="petFindAddr" id="">
							<option value="">请选择</option>
							<option value="">免费</option>
							<option value="">有偿</option>
						</select>
					</p>
				</div>
			...
			<div class="collected-right">
				...
				<div class="collected-right-con">
					...
					<p class="rr">
						<span>缩略图片：</span> <input type="file" id="multifile" name="upload" multiple >*
					</p>
					


					<p class="rr">
						<span>详细地址：</span> <select name="petFindAddr" id="">
